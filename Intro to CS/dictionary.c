...
unsigned int hash(const char *word)
{
    ...
    // consider a function on each character in a word to insurace uniqueness however will output
    // fit in N-1? to fit N do module % N output is the address in the linked list
